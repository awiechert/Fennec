...
Atom::Atom()
{
	atomic_weight = 0.0;					///< Holds the atomic weight of the atom
	oxidation_state = 0;					///< Holds the oxidation state of the atom
	protons = 0;							///< Holds the number of protons in the atom
	neutrons = 0;							///< Holds the number of neutrons in the atom
	electrons = 0;							///< Holds the number of electrons in the atom
	valence_e = 0;							///< Holds the number of valence electrons in the atom
	atomic_radii = 0;					///< Holds the van der Waals radii of the element (in angstroms)
	melting_point = 0.0;					///< Holds the melting point of the element (in K)
	boiling_point = 0;					///< Holds the boiling point of the element (in K)
	thermal_x_sec = 0;					///< Holds the thermal neutron cross section of the element (in barns)
	scatter_x_sec = 0;					///< Holds the scattering neutron cross section of the element (in barns)
	Name = "No Name";						///< Holds the name of the atom
	Symbol = "N/A";						///< Holds the atomic symbol for the atom
	Category = "N/A";					///< Holds the category of the atom (e.g., Alkali Metal)
	NaturalState = "N/A";				///< Holds the natural state of the atom (e.g., Gas)
	atomic_number = 0;						///< Holds the atomic number of the atom
}
