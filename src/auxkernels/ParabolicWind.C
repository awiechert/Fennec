 ...
 */
registerMooseObject("fennecApp", ParabolicWind);

InputParameters ParabolicWind::validParams()
{
...
ParabolicWind::ParabolicWind(const InputParameters & parameters) :
...
Real ParabolicWind::computeValue()
{
	Real _value;
	...
	if (z > _z_max)
		...
		_value = _v_max*pow(z/_z_max,_alpha) + _v_min;
