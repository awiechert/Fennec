/*!
 *  \file ShearMultiFragExponMonoPB.h
...
/// ShearMultiFragExponMonoPB class object forward declarations
class ShearMultiFragExponMonoPB;

/// ShearMultiFragExponMonoPB class object inherits from Kernel object
...
class ShearMultiFragExponMonoPB : public Kernel
{
public:
    ...
    ShearMultiFragExponMonoPB(const InputParameters & parameters);
