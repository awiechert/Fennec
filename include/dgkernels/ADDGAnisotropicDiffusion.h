/*!
 *  \file ADDGAnisotropicDiffusion.h
 *	\brief Discontinous Galerkin ADKernel for anisotropic diffusion
 *	\details This file creates a discontinous Galerkin ADKernel for anisotropic diffusion in a given domain. It is a generic
...
/// ADDGAnisotropicDiffusion class object forward declarations
class ADDGAnisotropicDiffusion;

/// ADDGAnisotropicDiffusion class object inherits from ADDGKernel object
...
class ADDGAnisotropicDiffusion : public ADDGKernel
{
public:
	...
	ADDGAnisotropicDiffusion(const InputParameters & parameters);
